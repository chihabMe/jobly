...
const JobDetail = ({ job }: { job: Job }) => {
  return (
    <div className="w-full min-h-screen  sticky  top-0   rounded-md px-4 py-6 outline-1 outline outline-text">
      {/* top */}
      <div className="flex flex-col bg-bg z-50 sticky  top-0   dark:bg-bg-dark   py-6 gap-4">
