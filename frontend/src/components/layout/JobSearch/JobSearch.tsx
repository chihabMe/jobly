...
const JobSearch = ({
  ...
  return (
    ...
    >
      <div className="my-2  w-full md:w-auto  outline-primary outline outline-1    rounded-sm">
        <input
          value={form.query}
          ...
          type="text"
          className="w-full md:w-80  py-4 bg-transparent outline-none rounded-sm px-4 text-title dark:text-title-dark"
          placeholder="job title or company..."
        />
      </div>

      <div className="my-2 z-10  w-full md:w-80 py-4 px-4 outline-1 outline-primary outline rounded-sm">
        <SelectMenu
          value={form.location}
