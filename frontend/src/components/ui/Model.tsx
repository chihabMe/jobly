...
const Model = ({ children, className }: Props) => {
  return (
    <>
      ...
      <Card
        className={`${className} p-3  shadow fixed flex flex-col gap-2 top-1/3 right-1/2 translate-x-1/2  -translate-y-1/2 w-full max-w-2xl    rounded-md bg-bg dark:bg-bg-dark `}
      >
        {children}
      </Card>
    </>
